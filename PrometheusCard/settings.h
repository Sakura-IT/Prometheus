...
#define MIB_DPMS_StandBy \
    (0)  // Monitor unterstützt DPMS-Level "stand-by".
         // Dieses Feature ist optional, nicht jeder
         // DPMS-fähige Monitor muß es unterstützen.
         // Aktivierung: hsync aus, vsync an

#define MIB_DPMS_Suspend \
    (1)  // Monitor unterstützt DPMS-Level "suspend".
         // Dieses Feature ist Pflicht, jeder
         // DPMS-fähige Monitor muß es unterstützen.
         // Aktivierung: hsync an, vsync aus

#define MIB_DPMS_ActiveOff \
    (2)  // Monitor unterstützt DPMS-Level "active off".
         // Dieses Feature ist Pflicht, jeder
         // DPMS-fähige Monitor muß es unterstützen.
